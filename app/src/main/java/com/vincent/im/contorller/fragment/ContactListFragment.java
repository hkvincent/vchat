...
import com.vincent.im.contorller.activity.AddContactActivity;
import com.vincent.im.contorller.activity.ChatActivity;
import com.vincent.im.contorller.activity.GroupListActivity;
import com.vincent.im.contorller.activity.InviteActivity;
import com.vincent.im.model.Model;
import com.vincent.im.model.bean.UserInfo;
import com.vincent.im.utils.Constant;
import com.vincent.im.utils.SpUtils;
            ...
            public void run() {
                ...
                try {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // toast提示
                            Toast.makeText(getActivity(), "delete " + mHxid + " successfully", Toast.LENGTH_SHORT).show();
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(getActivity(), "delete " + mHxid + " failed", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
