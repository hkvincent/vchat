package com.vincent.im.contorller.adatper;
...
/**
 * Created by Administrator on 2018/4/4 1:10
 */
        ...
        if (user != null) {// 联系人
            ...
            if (invationInfo.getStatus() == InvationInfo.InvitationStatus.NEW_INVITE) {// 新的邀请
                ...
                if (invationInfo.getReason() == null) {
                    hodler.reason.setText("add friend");
                } else {
            ...
            switch (invationInfo.getStatus()) {
                ...
                case GROUP_APPLICATION_ACCEPTED:
                    hodler.reason.setText("your group apply is accepted");
                    break;
                //  您的群邀请已经被接收
                case GROUP_INVITE_ACCEPTED:
                    hodler.reason.setText("your group apply is received");
                    break;

                // 你的群申请已经被拒绝
                case GROUP_APPLICATION_DECLINED:
                    hodler.reason.setText("your group apply is rejected");
                    break;

                // 您的群邀请已经被拒绝
                case GROUP_INVITE_DECLINED:
                    hodler.reason.setText("your group invite is rejected");
                    break;
                ...
                case NEW_GROUP_INVITE:
                    ...
                    hodler.reason.setText("you receive the group invite");
                    break;
                ...
                case NEW_GROUP_APPLICATION:
                    ...
                    hodler.reason.setText("receive the group apply");
                    break;

                // 你接受了群邀请
                case GROUP_ACCEPT_INVITE:
                    hodler.reason.setText("accept the group invite");
                    break;

                // 您批准了群申请
                case GROUP_ACCEPT_APPLICATION:
                    hodler.reason.setText("accept the group apply");
                    break;

                // 您拒绝了群邀请
                case GROUP_REJECT_INVITE:
                    hodler.reason.setText("reject the  group invite");
                    break;

                // 您拒绝了群申请
                case GROUP_REJECT_APPLICATION:
                    hodler.reason.setText("reject the group apply");
                    break;
            }
        }
