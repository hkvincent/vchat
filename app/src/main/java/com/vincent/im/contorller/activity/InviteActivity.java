...
import com.vincent.im.contorller.adatper.InviteAdapter;
import com.vincent.im.model.Model;
import com.vincent.im.model.bean.InvationInfo;
import com.vincent.im.utils.Constant;

import java.util.List;

/**
 * Created by Administrator on 2018/4/4 0:56
 */
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                // 页面发生变化
                                Toast.makeText(InviteActivity.this, "accept the invite", Toast.LENGTH_SHORT).show();
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InviteActivity.this, "accept the invite failed", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InviteActivity.this, "reject successfully", Toast.LENGTH_SHORT).show();
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InviteActivity.this, "reject failed", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InviteActivity.this, "reject the invite", Toast.LENGTH_SHORT).show();
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InviteActivity.this, "accept apply", Toast.LENGTH_SHORT).show();
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InviteActivity.this, "refuse apply", Toast.LENGTH_SHORT).show();
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(InviteActivity.this, "refuse apply failed", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
