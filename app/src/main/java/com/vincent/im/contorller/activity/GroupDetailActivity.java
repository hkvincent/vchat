...
import com.vincent.im.contorller.adatper.GroupDetailAdapter;
import com.vincent.im.model.Model;
import com.vincent.im.model.bean.UserInfo;
import com.vincent.im.utils.Constant;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by Administrator on 2018/4/6 0:45
 */
public class GroupDetailActivity extends Activity {
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(GroupDetailActivity.this, "delete successfully", Toast.LENGTH_SHORT).show();
                            }
                        });
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(GroupDetailActivity.this, "delete failed" + e.toString(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
                ...
                public void run() {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(GroupDetailActivity.this, "the invite is sent successfully", Toast.LENGTH_SHORT).show();
                            }
                        });
                    } catch (final HyphenateException e) {
                        e.printStackTrace();
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(GroupDetailActivity.this, "the invite is sent failed" + e.toString(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(GroupDetailActivity.this, "get information failed" + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
    ...
    private void initButtonDisplay() {
        ...
        if (EMClient.getInstance().getCurrentUser().equals(mGroup.getOwner())) {// 群主
            ...
            bt_groupdetail_out.setText("dismiss");
                        ...
                        public void run() {
                            try {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(GroupDetailActivity.this, "dismiss successfully", Toast.LENGTH_SHORT).show();
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(GroupDetailActivity.this, "dismiss failed" + e.toString(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        }
            ...
            bt_groupdetail_out.setText("exit");
                        ...
                        public void run() {
                            try {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(GroupDetailActivity.this, "exit successfully", Toast.LENGTH_SHORT).show();
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(GroupDetailActivity.this, "exit failed" + e.toString(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        }
