...
/**
 * Created by Administrator on 2018/4/2 20:05
 */
public class LoginAcitivity extends Activity {
    ...
    private void login() {
        ...
        if (TextUtils.isEmpty(loginName) || TextUtils.isEmpty(loginPwd)) {
            Toast.makeText(LoginAcitivity.this, "fill in the information", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                EMClient.getInstance().login(loginName, loginPwd, new EMCallBack() {
                    ...
                    public void onError(int i, final String s) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(LoginAcitivity.this, "login failed" + s, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
            ...
            public void run() {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(LoginAcitivity.this, "sign up successfully", Toast.LENGTH_SHORT).show();
                        }
                    });
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(LoginAcitivity.this, "sign up failed" + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
